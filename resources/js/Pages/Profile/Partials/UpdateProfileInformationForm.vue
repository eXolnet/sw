            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-gray-200">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="underline text-sm text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-broom-500 dark:focus:ring-offset-gray-800"
                    >
